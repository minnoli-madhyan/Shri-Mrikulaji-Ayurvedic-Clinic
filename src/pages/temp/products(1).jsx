        ...
        {!loading && featuredProduct && featuredMatchesSearch && (
          <div className="max-w-5xl mx-auto mb-24">
            <motion.div
              ...
              className="bg-white rounded-[2.5rem] shadow-xl border border-accent/40 overflow-hidden flex flex-col md:flex-row items-stretch hover:shadow-2xl transition-all duration-500"
            >
              {/* ── Image: top on mobile, right slab on desktop ── */}
              {getProductImageUrl(featuredProduct.image_url) && (
                <div className="w-full h-64 md:hidden overflow-hidden rounded-t-[2.5rem]">
                  <img
                    src={getProductImageUrl(featuredProduct.image_url)}
              ...
              {/* ── Right slab image — desktop only ── */}
              <div className="hidden md:flex relative w-2/5 self-stretch overflow-hidden">
                {getProductImageUrl(featuredProduct.image_url) ? (
                  <img
                    src={getProductImageUrl(featuredProduct.image_url)}
                    alt={field(featuredProduct, 'name')}
                  ...
                  <div className="absolute inset-0 bg-cream/20 border-l border-accent/30 flex items-center justify-center">
