        ...
        {!loading && featuredProduct && featuredMatchesSearch && (
          <div className="max-w-5xl mx-auto mb-24">
            ...
            >
              ...
              {/* Product image — full-bleed cover on the right slab */}
              <div className="relative w-full md:w-3/7 min-h-[280px] md:min-h-0 overflow-hidden rounded-b-[2.5rem] md:rounded-b-none md:rounded-r-[2.5rem]">
